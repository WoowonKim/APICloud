 ...
 */
package com.web.apicloud.dummy;
...
// source: io.spring.initializr.generator.test.InitializrMetadataTestBuilder
// FIXME: Implement Builder
public class DummyInitializrMetadataBuilder {

    private final InitializrMetadataBuilder builder = InitializrMetadataBuilder.create();

    public static DummyInitializrMetadataBuilder withDefaults() {
        return new DummyInitializrMetadataBuilder().addAllDefaults();
    }

    public static DummyInitializrMetadataBuilder withBasicDefaults() {
        return new DummyInitializrMetadataBuilder().addBasicDefaults();
    }
    ...
    public DummyInitializrMetadataBuilder addDependencyGroup(String name, String... ids) {
    ...
    public DummyInitializrMetadataBuilder addDependencyGroup(String name, Dependency... dependencies) {
        this.builder.withCustomizer((it) -> {
            DependencyGroup group = new DependencyGroup();
            group.setName(name);
    ...
    public DummyInitializrMetadataBuilder addType(String id, boolean defaultValue, String action, String build,
                                                  String format) {
        Type type = new Type();
        type.setId(id);
        type.setName(id);
    ...
    public DummyInitializrMetadataBuilder addType(Type type) {
        this.builder.withCustomizer((it) -> it.getTypes().getContent().add(type));
        return this;
    }

    public DummyInitializrMetadataBuilder addDefaultPackagings() {
        return addPackaging("jar", true).addPackaging("war", false);
    }

    public DummyInitializrMetadataBuilder addPackaging(String id, boolean defaultValue) {
        this.builder.withCustomizer((it) -> {
    ...
    public DummyInitializrMetadataBuilder addDefaultJavaVersions() {
        return addJavaVersion("1.6", false).addJavaVersion("1.7", false).addJavaVersion("1.8", true);
    }

    public DummyInitializrMetadataBuilder addJavaVersion(String version, boolean defaultValue) {
        this.builder.withCustomizer((it) -> {
    ...
    public DummyInitializrMetadataBuilder addDefaultLanguages() {
        return addLanguage("java", true).addLanguage("groovy", false).addLanguage("kotlin", false);
    }

    public DummyInitializrMetadataBuilder addLanguage(String id, boolean defaultValue) {
        this.builder.withCustomizer((it) -> {
            DefaultMetadataElement element = new DefaultMetadataElement();
            element.setId(id);
            element.setName(id);
    ...
    public DummyInitializrMetadataBuilder addDefaultBootVersions() {
    ...
    public DummyInitializrMetadataBuilder addBootVersion(String id, boolean defaultValue) {
        this.builder.withCustomizer((it) -> {
            DefaultMetadataElement element = new DefaultMetadataElement();
            element.setId(id);
            element.setName(id);
    ...
    public DummyInitializrMetadataBuilder addBom(String id, String groupId, String artifactId, String version) {
        BillOfMaterials bom = BillOfMaterials.create(groupId, artifactId, version);
        return addBom(id, bom);
    }

    public DummyInitializrMetadataBuilder addBom(String id, BillOfMaterials bom) {
        this.builder.withCustomizer((it) -> it.getConfiguration().getEnv().getBoms().put(id, bom));
        return this;
    }

    public DummyInitializrMetadataBuilder setPlatformCompatibilityRange(String platformCompatibilityRange) {
        this.builder.withCustomizer(
                (it) -> it.getConfiguration().getEnv().getPlatform().setCompatibilityRange(platformCompatibilityRange));
        return this;
    }

    public DummyInitializrMetadataBuilder setPlatformVersionFormatCompatibilityRange(String v1Range, String v2Range) {
        this.builder.withCustomizer((it) -> {
    ...
    public DummyInitializrMetadataBuilder setGradleEnv(String dependencyManagementPluginVersion) {
    ...
    public DummyInitializrMetadataBuilder setKotlinEnv(String defaultKotlinVersion, InitializrConfiguration.Env.Kotlin.Mapping... mappings) {
        this.builder.withCustomizer((it) -> {
    ...
    public DummyInitializrMetadataBuilder setMavenParent(String groupId, String artifactId, String version,
    ...
    public DummyInitializrMetadataBuilder addReleasesRepository(String id, String name, String url) {
        return addRepository(id, name, url, true, false);
    }

    public DummyInitializrMetadataBuilder addSnapshotsRepository(String id, String name, String url) {
        return addRepository(id, name, url, false, true);
    }

    public DummyInitializrMetadataBuilder addRepository(String id, String name, String url, boolean releasesEnabled,
